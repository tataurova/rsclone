...
const isLoginValid = (input, evt) => input.current.validity.valid && evt.target.value.length >= LOGIN_MIN_LENGTH;

const isPasswordValid = (input, evt) => input.current.validity.valid && evt.target.value.length >= PASSWORD_MIN_LENGTH;
